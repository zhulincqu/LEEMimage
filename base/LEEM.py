...
class LEEMImage:
    ...
    def _load_file(self):
        ...
        with open(self.filename, 'rb') as f:
            ...
            #235: COL, 236:Gauge 3, 237:PCH,
            gauge_tags = [106, 107, 108, 109, 235, 236, 237] 
            temperature = [176]
            for b in b_iter:
...
if __name__ == '__main__':
    ...
    # for test purposes
    #im = LEEMImage('testfiles/LEEM.dat')
    #im = LEEMImage('testfiles/LEED.dat')
    #im = LEEMImage('testfiles/PES.dat')
    im = LEEMImage('testfiles/PED.dat')    
    #im.normalizeOnCCD()
